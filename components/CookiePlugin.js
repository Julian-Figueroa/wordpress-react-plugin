class CookiePlugin extends React.Component {
  ...
  render() {
    return this.state.visible ? (
      <div
        class="CookieBanner container fixed-bottom alert alert-light border alert-dismissible fade show"
        role="alert"
        ref="cookieBanner"
      >
        <div class="row justify-content-between align-items-stretch">
          ...
          <div class="col-8">
            ...
            <p class="lh-base fs-6 m-0">
              Cookies let us give you a better experience and improve our products.
              <br />
          ...
          <div class="col-2">
            <div class="row">
              <button id="accept" onClick={this.acceptCookies} type="button" class="btn btn-info text-white mb-2">
                Accept
              </button>
              <button id="decline" onClick={this.declineCookies} type="button" class="btn btn-outline-info">
                Decline
              </button>
            </div>
          </div>
